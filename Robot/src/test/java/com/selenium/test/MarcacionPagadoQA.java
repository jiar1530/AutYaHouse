...
public class MarcacionPagadoQA {
...
By MarcacionPagado = By.xpath("//*[@id=\"terceros:tbody_element\"]/tr[19]/td/a");
...
public static Collection<Object[]> listaTextos() {
	...
	try {
		...
		String sql = "select id_hogar from mcy_hogar WHERE estado_actual=10 and ROWNUM <= 2 order by id_hogar asc";
...
public MarcacionPagadoQA(String id_hogar) {
...
//		Thread.sleep(2000);
	    ...
	    driver.findElement(MarcacionPagado).click();
	    Thread.sleep(2000);
