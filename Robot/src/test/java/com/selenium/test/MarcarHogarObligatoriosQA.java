...
public class MarcarHogarObligatoriosQA {
		 	 ...
		 	 try {
		 		...
		 		Conectar oracle=new Conectar();
		 	 	...
		 	 	con=oracle.conectar();
		 	 	   ...
		 	 	   String sql1= "Select mh.id_hogar from mcy_hog_tercero ht inner join mcy_hogar mh on mh.id_hogar = ht.id_hogar where mh.estado_actual = '1' and mh.tipo_entidad='999' and mh.codigo_entidad='1' and rownum < = 2";
...
//		 		  
	...
	//
	   ...
	   public MarcarHogarObligatoriosQA(String Id_Hogar) {
