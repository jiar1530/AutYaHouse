...
public class RegistrarHogarCamposNoObligatorios {
...
//*[@id="form1:vendor"]
  ...
  public RegistrarHogarCamposNoObligatorios(String Cedula, String Nombre, String Lugar_expedicion,String Nombre_Departamento, String Fecha_Nacimiento1) {
	   this.Cedula = Cedula;
	   this.Nombre = Nombre;
		         ...
		         if (b1==true) {
		          ...
		          // driver.findElement(BotonAdicionarIntegrante).click();
		           ...
		           // driver.findElement(DesplegableMunicipio).sendKeys(Lugar_expedicion);
			        ...
			        System.out.println("Automatizacion Registrar Hogares Obligatorio: True");
